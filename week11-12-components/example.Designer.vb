...
Partial Class example
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(example))
        ...
        RichTextBox1.Size = New Size(329, 554)
        RichTextBox1.TabIndex = 0
        RichTextBox1.Text = resources.GetString("RichTextBox1.Text")
        ' 
        ' ListBox1
        ' 
        ListBox1.Font = New Font("Consolas", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        ...
        Label2.TabIndex = 4
        Label2.Text = "Input Word to Manipulate:"
        ' 
        ' Button1
        ' 
        ...
        Label3.Location = New Point(403, 77)
        Label3.Name = "Label3"
        Label3.Size = New Size(405, 46)
        Label3.TabIndex = 7
        Label3.Text = ".NET Framework Method"
        ' 
        ' example
        ' 
