...
Partial Class week1_components
    ...
    Private Sub InitializeComponent()
        ...
        Button3.TabIndex = 4
        Button3.Text = "Assignment 6"
        Button3.UseVisualStyleBackColor = True
        ' 
        ' Button2
        ' 
        Button2.Location = New Point(3, 162)
